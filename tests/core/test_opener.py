...
from targets.core.mock import MockTarget
from targets.core.opener import OpenerTarget, NoOpenerError
...
class TestOpenerTarget(unittest.TestCase):
    ...
    @mock.patch('targets.LocalTarget.__init__')
    @mock.patch('targets.LocalTarget.__del__')
    ...
    @mock.patch('targets.s3.S3Target.__init__')
    ...
    def test_binary_support(self):
        ...
        if six.PY3:
            ...
            fp = OpenerTarget("mock://file.txt",
                              format=targets.format.MixedUnicodeBytes).open('w')
